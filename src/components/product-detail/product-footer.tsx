  ...
  return (
    <footer className="bg-surface/95 backdrop-blur-md py-[80px] border-t-2 border-dashed border-outline-variant relative z-10">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 w-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12 w-full">
          {/* Cột 1: Đơn vị thực hiện */}
          <div className="flex flex-col gap-4">
            <h4 className="font-bold text-primary text-xl font-headline">
              Đơn vị thực hiện
            </h4>
            <div className="text-on-surface-variant text-base font-body space-y-2">
              <p className="font-semibold text-tertiary">
                Dự án &ldquo;Điều Em Muốn&rdquo;
              </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="text-on-surface-variant text-base font-body space-y-2">
              ...
              <p className="flex items-center gap-2">
                ...
                <span>Email:</span>
                <a
                  href="mailto:dieuemmuonnnn@gmail.com"
                  className="hover:text-primary transition-colors font-semibold"
                >
                  dieuemmuonnnn@gmail.com
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="text-on-surface-variant text-base font-body space-y-2">
              <p className="flex items-center gap-2">
                ...
                <span>Fanpage:</span>
                <a
                  href="https://www.facebook.com/profile.php?id=61590436748725&locale=vi_VN"
                  target="_blank"
              ...
              <p className="flex items-center gap-2">
                ...
                <span>TikTok:</span>
                <a
                  href="https://www.tiktok.com/@iu.em.mun50"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary transition-colors font-semibold"
                >

...
export const artworks: Artwork[] = [
  {
    ...
    artistStory: "Nghiêm Thị Phương Thảo là học sinh người Kinh đến từ thôn Đoàn Kết. Em mắc khuyết tật trí tuệ, rối loạn tâm thần, tăng động giảm chú ý và khó kiểm soát hành vi. Gia đình em có hoàn cảnh khó khăn, công việc và thu nhập của bố mẹ đều không ổn định.",
    dream: "Mỗi nét vẽ là một điều em muốn nói. Trong từng nét vẽ còn vụng về ấy là sự hồn nhiên, là niềm vui, là khát khao được yêu thương và được nhìn thấy như bao người khác.",
    description: "Ngôi sao đỏ ở trung tâm như một biểu tượng của niềm tự hào, của những điều đẹp đẽ mà em luôn hướng tới.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Nguyễn Cao Phong là học sinh người Kinh đến từ thôn Đoàn Kết. Em mắc khuyết tật trí tuệ, khuyết tật ngôn ngữ, tăng động giảm chú ý và gặp khó khăn trong việc kiểm soát hành vi. So với nhiều bạn khác, hoàn cảnh gia đình em ổn định hơn.",
    dream: "Em mong muốn mọi đứa trẻ đều được sống trong bình yên, được yêu thương và được tự hào về nơi mình thuộc về.",
    description: "Đất nước hiện lên qua lá cờ thân thuộc, qua mái nhà bình yên, qua ánh nắng ấm áp mỗi ngày.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Hà Quỳnh Chi là học sinh dân tộc Tày sinh sống tại khu Trung Tâm. Em mắc khuyết tật trí tuệ, tự kỷ và tăng động giảm chú ý. Gia đình em thuộc diện khó khăn khi bố mẹ đều chưa có việc làm ổn định, ảnh hưởng đến điều kiện chăm sóc và học tập của em.",
    dream: "Hạnh phúc đôi khi không phải là những điều lớn lao, mà đơn giản chỉ là được trở về nhà sau một ngày dài, nhìn thấy những người mình yêu thương và cảm nhận sự bình yên quen thuộc.",
    description: "Ngôi nhà hiện lên với những gam màu tươi sáng, như một biểu tượng của sự an toàn và yêu thương.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Trịnh Ngọc Huy là học sinh dân tộc Sán Chay ở thôn Ngòi Chán. Em mắc khuyết tật trí tuệ, khuyết tật ngôn ngữ, khuyết tật thị giác và rối loạn phổ tự kỷ. Gia đình thuộc diện khó khăn khi mẹ thường xuyên đau ốm, còn bố không có công việc ổn định.",
    dream: "Trong cuộc sống, ai cũng cần một bàn tay nâng đỡ, một nơi để cảm thấy an toàn và những người để yêu thương.",
    description: "Bàn tay lớn ở trung tâm giống như một vòng tay che chở, ôm lấy mọi điều quan trọng trong thế giới của em.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Hoàng Ngọc Tú là học sinh dân tộc Dao ở thôn Đát Lụa. Em mắc khuyết tật trí tuệ, khuyết tật ngôn ngữ, chậm phát triển thể chất, tăng động giảm chú ý và không làm chủ được hành vi. Gia đình rất khó khăn, có hai người con bị khuyết tật nặng, bố mẹ không có việc làm ổn định, nhà ở xa lớp học và không có phương tiện đưa đón.",
    dream: "Thế giới của em được tạo nên từ trí tưởng tượng, từ những điều em yêu thương và cảm nhận bằng cả trái tim.",
    description: "Một bông hoa lớn, một mái nhà bình yên, ánh mặt trời ấm áp – đó có lẽ là những điều khiến em hạnh phúc.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Hà Kim Anh là học sinh dân tộc Tày, sinh sống tại thôn Ngòi Khang. Em mắc khuyết tật trí tuệ, tăng động giảm chú ý và gặp khó khăn trong việc kiểm soát hành vi. Gia đình thuộc diện khó khăn, chưa có công việc và nguồn thu nhập ổn định.",
    dream: "Trẻ em thường có cách thể hiện tình cảm rất đơn giản. Các em không cần những lời nói hoa mỹ hay những thông điệp lớn lao. Đôi khi, chỉ một trái tim được tô thật cẩn thận cũng đủ để nói lên rất nhiều điều.",
    description: "Một trái tim lớn đến vậy như muốn nói rằng trong thế giới của Kim Anh luôn có chỗ cho sự yêu thương.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Hoàng Ngọc Chiến là học sinh dân tộc Dao, sinh sống tại thôn Ngòi Ngần. Em mắc bệnh tim bẩm sinh, khuyết tật trí tuệ, khuyết tật ngôn ngữ, khuyết tật thị giác và tự kỷ. Gia đình em rơi vào hoàn cảnh đặc biệt khó khăn khi ngôi nhà bị cuốn trôi hoàn toàn sau cơn bão Yagi. Mẹ em thường xuyên phải điều trị bệnh, còn bố không có việc làm ổn định.",
    dream: "Điều đẹp nhất trong bức tranh này không nằm ở những gì được vẽ ra, mà nằm ở niềm hạnh phúc rất giản dị của Chiến khi được tự do thể hiện thế giới trong mắt mình.",
    description: "Điều đáng quý nằm ở cách em tự do kể câu chuyện của mình trên trang giấy, bằng những nét vẽ hồn nhiên nhất.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Lý Thị Huệ là học sinh dân tộc Dao ở thôn Khe May, xã Yên Bình. Em bị khuyết tật trí tuệ, khuyết tật ngôn ngữ, tự kỷ và thường xuyên run chân tay. Gia đình rất khó khăn, đông con, bố mẹ không có việc làm ổn định. Nhà cách lớp học khoảng 14 km và không có phương tiện đưa đón nên việc đến lớp của em gặp nhiều trở ngại.",
    dream: "Bằng những nét vẽ trong trẻo nhất, Huệ đã bộc lộ khát vọng hạnh phúc, mong muốn dùng chính đôi bàn tay của mình để chạm vào thế giới, để sẻ chia và lan tỏa sự ấm áp đến mọi người xung quanh.",
    description: "Bao bọc lấy bàn tay ấy là những trái tim đỏ thắm lớn nhỏ đang bay lượn tự do, tạo nên năng lượng tích cực.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Hoàng Thị Huế là học sinh dân tộc Tày đến từ thôn Làng Giữa. Em mắc khuyết tật trí tuệ, chậm phát triển thể chất và suy dinh dưỡng. Gia đình có hoàn cảnh khó khăn khi cả bố và mẹ đều chưa có việc làm ổn định, ảnh hưởng lớn đến điều kiện chăm sóc và học tập của em.",
    dream: "Qua những nét vẽ mộc mạc của Huế, chúng ta nhận ra rằng hạnh phúc đôi khi không đến từ những điều lớn lao. Với một đứa trẻ, hạnh phúc có thể chỉ đơn giản là một ngôi nhà thân quen, một ngày nhiều nắng và những người yêu thương luôn ở bên cạnh.",
    description: "Mái nhà để trở về, là cây cối và hoa lá trong sân, là lá cờ Tổ quốc và bầu trời đầy nắng ấm áp.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "Lê Ngọc Mai là học sinh người Kinh, sinh sống tại thôn Ngòi Khang. Do sinh non, em gặp nhiều vấn đề về sức khỏe như khuyết tật trí tuệ, tăng động giảm chú ý, suy dinh dưỡng và mắc bệnh đường tiêu hóa mãn tính. Gia đình em gặp nhiều khó khăn về kinh tế, công việc không ổn định và mẹ thường xuyên đau ốm.",
    dream: "Mỗi nét vẽ đều là cách em kể câu chuyện của riêng mình, bằng những gì em nhìn thấy, yêu thích và mơ ước. Qua những nét vẽ hồn nhiên này, cho thấy đó không phải là những điều lớn lao, nhưng lại là những điều khiến tuổi thơ trở nên thật đẹp.",
    description: "Bức tranh em vẽ không chỉ là một ngôi nhà, mà là thấy cả một ước mơ về sự bình yên và hạnh phúc của em.",
    fullStory: [
  ...
  },
  {
    ...
    artistStory: "La Quốc Bảo là học sinh dân tộc Tày, sinh sống tại thôn Làng Giữa. Em bị khuyết tật vận động, khuyết tật ngôn ngữ và teo cơ co cứng, gây nhiều khó khăn trong sinh hoạt cũng như học tập. Gia đình em thuộc diện khó khăn, trong khi mẹ em vừa gặp tai nạn nên cuộc sống càng thêm nhiều vất vả.",
    dream: "Em mong muốn vượt qua những khó khăn thể chất để tự lập và đỡ đần cho người mẹ thân yêu gánh vác gia đình.",
  ...
  },
  {
    ...
    artistStory: "Nông Anh Minh là học sinh người Kinh đến từ thôn Làng Giữa. Em mắc khuyết tật trí tuệ, tự kỷ, tăng động giảm chú ý và gặp khó khăn trong việc kiểm soát hành vi. Gia đình em thuộc diện khó khăn, bố mẹ không có công việc ổn định nên việc chăm sóc và hỗ trợ em trong học tập còn nhiều hạn chế.",
    dream: "Em ước mơ có một môi trường học tập vui vẻ, luôn tràn ngập sự thấu hiểu, sẻ chia và yêu thương từ mọi người.",
    description: "Tác phẩm đang được trưng bày trực tiếp tại triển lãm vật lý.",
    fullStory: [
